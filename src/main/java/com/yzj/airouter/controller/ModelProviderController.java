...
public class ModelProviderController {
     ...
     */
    @PostMapping("save")
    public boolean save(@RequestBody ModelProvider modelProvider) {
        return modelProviderService.save(modelProvider);
    }
     ...
     */
    @PutMapping("update")
    public boolean update(@RequestBody ModelProvider modelProvider) {
        return modelProviderService.updateById(modelProvider);
    }
    ...
    public ModelProvider getInfo(@PathVariable Long id) {
     ...
     */
    @GetMapping("page")
    public Page<ModelProvider> page(Page<ModelProvider> page) {
