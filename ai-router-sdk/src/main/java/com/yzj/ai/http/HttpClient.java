...
public class HttpClient {
            ...
            try (Response response = okHttpClient.newCall(httpRequest).execute()) {
                ...
                if (retryCount <= config.getMaxRetries()) {
                    ...
                    try {
                        ...
                        throw new AIException("Request interrupted", ie);
                    }
                }
            }
        }

        throw new AIException("Request failed after " + config.getMaxRetries() + " retries", lastException);
    }
    ...
    public void chatStream(ChatRequest request, StreamCallback callback) {
        ...
        try {
            ...
            if (body == null) {
                throw new AIException("Response body is null");
            }
